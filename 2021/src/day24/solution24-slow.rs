...
// This is the naive solution which, while correct and more general,
// is extremely slow. See solution24.rs for a solution that's far faster
// because it makes many assumptions about the input instructions.
